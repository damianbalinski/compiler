...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_COM_1 = 3,                      /* COM_1  */
  YYSYMBOL_COM_2 = 4,                      /* COM_2  */
  YYSYMBOL_JUMP_1 = 5,                     /* JUMP_1  */
  YYSYMBOL_JUMP_2 = 6,                     /* JUMP_2  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "COM_1", "COM_2",
  "JUMP_1", "JUMP_2", "STOP", "REG", "LABEL", "ERROR", "$accept", "input",
  "line", YY_NULLPTR
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, vector< tuple<int,int,int> > & program)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (program);
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, vector< tuple<int,int,int> > & program)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, vector< tuple<int,int,int> > & program)
{
  YYUSE (yyvaluep);
  YYUSE (program);
  if (!yymsg)
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: COM_1 REG  */
#line 48 "parser.y"
                { program.push_back( make_tuple(yyvsp[-1],yyvsp[0],0) ); }
#line 1082 "parser.cc"
    break;

  case 5: /* line: COM_2 REG REG  */
#line 49 "parser.y"
